...
- Mouse support and terminal integration

**Neovim Configuration (`init.vim` and `coc-settings.json`)**:
- Additional Neovim-specific configurations
- Coc.nvim language server configurations for intelligent code completion
